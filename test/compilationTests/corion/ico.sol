...
contract ico is safeMath {
    ...
    function buy(address beneficiaryAddress, address affilateAddress) payable returns (bool success) {
        /*
            ...
            If there is not at least 0.2 xlt balance on the beneficiaryAddress then the amount of the xlt which was intended for the purchase will be reduced by 0.2 and that will be sent to the address of the beneficiary.
        ...
        */
        ...
        if ( beneficiaryAddress.balance < 0.2 xlt ) {
            require( beneficiaryAddress.send(0.2 xlt) );
            _value = safeSub(_value, 0.2 xlt);
        }
    ...
    function getIcoReward(uint256 value) public constant returns (uint256 reward) {
        /*
            ...
            @value The amount of xlt for the purchase
        ...
        */
        reward = (value * 1e6 * icoExchangeRate / icoExchangeRateM / 1 xlt) * (ICObonus() + 100) / 100;
