...
/// @title Token contract - Token exchanging Xlt 1:1
...
contract EtherToken is StandardToken {
     ...
     *  Constants
     */
    string public constant name = "Xlt Token";
    string public constant symbol = "Xlt";
    uint8 public constant decimals = 18;

    /*
     *  Public functions
     */
    /// @dev Buys tokens with Xlt, exchanging them 1:1
    function deposit()
        public
        payable
    {
    ...
    /// @dev Sells tokens in exchange for Xlt, exchanging them 1:1
